...
//	}
    ...
    public ResponseEntity<Object> fogotPassword(@RequestParam("email") String email) {
        return new ResponseEntity<Object>(accountService.sendFogotPasswordMail(email), HttpStatus.OK);
    }
